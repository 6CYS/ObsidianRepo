...
我们要做什么什么样？产品的定位是什么？
我们做的这个和市面上商业化产品相比，优势是什么？怎么能够切入到实际客户的痛点中？
开源的软件中哪些是适合与我们这个需求的？用这些开源软件之后，我们还需要做什么？
技术栈的选择应该怎么选？
整体的架构是什么样的？
未来是否以及如何与我们的数据治理平台和数据资产平台做整合？


----

使用 WrenAI 的话，WrenAI本身的UI只能说是一个管理后台，它本身不具备用户和权限管理的能力，这块是需要我们套壳去做的。

另外，还需要做后台管理、对话隔离等一系列管理类的功能，来完善成一个企业级的产品。

WrenAI有一个局限性是，把SQL生成的过程固化在他的流程里，我们如果需要加入更多的上下文给大模型的话，就需要我们自己开发 Rag 的过程，这个时候，就需要引入其他的框架来做，比如 Vanna AI这样的简化做Rag的框架。
